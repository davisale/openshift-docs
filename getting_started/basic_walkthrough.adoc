...
*openshift/nodejs-ex* repository. In the
...
. Navigate to the *welcome page* of the {product-title} web console and click *[ New Project ]* to create
your first project:
+
[NOTE]
====
...
In the *web console*, view the *Overview* page for your project to determine the web address for your
...
Next, we’ll go *beyond the basics*
